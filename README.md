...
1. Launch Ghosts on Steam.
2. **TIMING IS KEY:** Wait for the splash screen image to pop up on your screen.  
   *(Inject it right as this image appears, otherwise the game will just die like usual).*

   ![CoD Ghosts Splash Screen](img.png)

3. Open Process Hacker (or whatever DLL injector you like).
4. Find iw6mp64_ship.exe, right-click it, go to Miscellaneous -> Inject DLL.
5. Select this compiled .dll file, and you're good to go!
